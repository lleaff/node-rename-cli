/*
 * Yes, we extend native element prototypes. Is it a good idea? No. Would I do
 * it again? No. But for the purpose of a small CLI tool, this isn't a big deal.
 * This should be refactored if one wanted to extract the Node.js API into a
 * standalone library.
 */
...
override_prop(Object.prototype, 'forEach',
    function forEach(callback, thisArg = null) {
        Object.entries(this).forEach(
            (entry, i) => callback.call(thisArg, entry, i, this));
    });
 ...
 * @param {int} [callbackPos] - Manually specify callback argument position, default to final argument
 */
